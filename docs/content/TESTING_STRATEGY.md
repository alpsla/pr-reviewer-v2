...
Some previously automated tests have been skipped in favor of manual testing. These are documented in the packages/core README.md file, which explains:

- Which test files are skipped
...
For UI components, we follow a primarily manual testing approach:

1. **Visual Testing**: Verify component appearance and styling
