    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {/* Card 1: Save Time */}
          <div className="group flex flex-col items-center rounded-lg border bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 dark:shadow-black/10 dark:border-slate-700 hover:-translate-y-1">
            ...
            <h3 className="mb-2 text-xl font-bold">40% Faster Reviews</h3>
          ...
          <div className="group flex flex-col items-center rounded-lg border bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 dark:shadow-black/10 dark:border-slate-700 hover:-translate-y-1">
            ...
            <h3 className="mb-2 text-xl font-bold">Reduce Bugs by 30%</h3>
            <p className="text-muted-foreground">
