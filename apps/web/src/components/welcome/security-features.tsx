      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-lg border bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 shadow-lg dark:shadow-black/20 hover:shadow-xl transition-all duration-300 dark:border-slate-700">
            ...
            <h3 className="mb-2 text-lg font-bold text-slate-800 dark:text-slate-100">Your Code Stays Private</h3>
          ...
          <div className="rounded-lg border bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 shadow-lg dark:shadow-black/20 hover:shadow-xl transition-all duration-300 dark:border-slate-700">
            ...
            <h3 className="mb-2 text-lg font-bold text-slate-800 dark:text-slate-100">Secure Authentication</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300">
          ...
          <div className="rounded-lg border bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 shadow-lg dark:shadow-black/20 hover:shadow-xl transition-all duration-300 dark:border-slate-700">
            ...
            <h3 className="mb-2 text-lg font-bold text-slate-800 dark:text-slate-100">Compliance Ready</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300">
          ...
          <div className="rounded-lg border bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 shadow-lg dark:shadow-black/20 hover:shadow-xl transition-all duration-300 dark:border-slate-700">
            ...
            <h3 className="mb-2 text-lg font-bold text-slate-800 dark:text-slate-100">Isolated LLM Processing</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300">
        ...
        <div className="mt-10 rounded-lg border bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm p-4 text-center shadow-lg dark:shadow-black/20 dark:border-slate-700">
          <p className="mb-2 text-lg font-semibold text-slate-700 dark:text-slate-200">Security is our priority</p>
          ...
          <Button variant="link" size="sm" className="mt-2 text-blue-600 hover:text-blue-700 dark:text-blue-300 dark:hover:text-blue-200">
