...
const InlineCode = React.forwardRef<HTMLElement, InlineCodeProps>(
  ({ className, size = "sm", ...props }, ref) => {
    return (
      <code
        ref={ref}
        className={cn(codeVariants({ size, variant: "inline", className }))}
        {...props}
      />
    );
  }
...
const BlockCode = React.forwardRef<HTMLPreElement, BlockCodeProps>(
  ({ className, size = "sm", ...props }, ref) => {
    return (
      <pre
        ref={ref}
        className={cn(codeVariants({ size, variant: "block", className }))}
        {...props}
      />
    );
  }
...
// Unified Code component (convenience wrapper)
export interface CodeProps extends Omit<InlineCodeProps, "ref"> {
  variant?: "inline" | "block";
}

const Code: React.FC<CodeProps> = ({ variant = "inline", ...props }) => {
  if (variant === "block") {
...
export { Heading, Text, Code, InlineCode, BlockCode, Link, headingVariants, textVariants, codeVariants, linkVariants };
